...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _handleLogin() async {
    ...
    try {
      ...
      // Intentar login
      // Usar el login controlado que verifica tanto auth como tabla usuarios
      final usuario = await UsuarioService.loginConControl(
        _emailController.text.trim(),
        _passwordController.text,
      );

      // Si llegamos aquí, el login fue exitoso y el usuario está activo
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('¡Bienvenido ${usuario?.nombre ?? usuario?.email}!'),
